# Semantic Video Search Service

## Overview
Search your videos using natural language! This service uses AWS AI services to analyze video content and enable semantic search based on what's happening in the videos.
